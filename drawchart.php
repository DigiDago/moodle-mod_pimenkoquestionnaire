...
function draw_chart($feedbacktype, $charttype=null, $labels,
    ...
    $charttitlesize = 10;
    $charttitlesize2 = 10;
    if ($PAGE->pagetype == 'mod-pimenkoquestionnaire-myreport') {
        $charttitle = get_string('yourresponse', 'pimenkoquestionnaire');
    } else {
        $charttitle = get_string('thisresponse', 'pimenkoquestionnaire');
    }
