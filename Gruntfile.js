// This file is part of the pimenko tabs plugin
//
...
module.exports = function(grunt) {
    ...
    let moodleroot = path.dirname(path.dirname(path.dirname(__dirname))),
        decachephp = '',
    ...
    let configfile = path.join(moodleroot, 'config.php');
    ...
    grunt.initConfig({
        ...
        watch: {
            // Watch for any changes to scss files and compile.
            files: ["scss/*.scss"],
            tasks: ["compile"],
            options: {
                livereload: true
