...
$string['alignment_link'] = 'mod/pimenkoquestionnaire/questions#Radio_Buttons';
$string['all'] = 'Tout';
...
$string['checkboxes_link'] = 'mod/pimenkoquestionnaire/questions#Check_Boxes';
...
$string['createcontent_link'] = 'mod/pimenkoquestionnaire/mod#Content_Options';
...
$string['downloadtextformat_link'] = 'mod/pimenkoquestionnaire/report#Download_in_text_format';
...
$string['dropdown_link'] = 'mod/pimenkoquestionnaire/questions#Dropdown_Box';
$string['edit'] = 'Modifier';
$string['editingfeedback'] = 'Modification des paramètres de feedback';
$string['editingpimenkoquestionnaire'] = 'Modification du questionnaire  - page Générale';
...
$string['incorrectpimenkoquestionnaire'] = 'Questionnaire incorrect';
...
$string['kindofratescale_link'] = 'mod/pimenkoquestionnaire/questions#Type_of_rate_scale';
...
$string['notifications_help'] = 'Notifier les rôles ayant la capacité « mod/pimenkoquestionnaire:submissionnotification » lorsqu\'un envoi est faite.';
...
$string['optionalname_link'] = 'mod/pimenkoquestionnaire/questions#Question_Name';
$string['or'] = '- OU -';
...
$string['orderresponses_link'] = 'mod/pimenkoquestionnaire/report#Order_Responses';
...
$string['preview_pimenkoquestionnaire'] = 'Prévisualisation du Questionnaire';
...
$string['privacy:metadata:pimenkoquestionnaire:pimenko_resp_multiple'] = 'Une réponse à une question à choix multiples.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_resp_multiple:choice_id'] = 'L\'identifiant d\'un enregistrement du choix pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_resp_multiple:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_resp_multiple:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response'] = 'Une réponse en cours ou envoyée';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_bool'] = 'Une réponse à la question booléenne (oui/non).';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_bool:choice_id'] = 'La réponse booléenne spécifique.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_bool:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_bool:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response:complete'] = 'Le statut d\'achèvement de la réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_date'] = 'Une réponse à une question de date.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_date:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_date:response'] = 'La date spécifique de réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_date:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response:grade'] = 'La note pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_other'] = 'Une réponse de type « autre » choix.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_other:choice_id'] = 'L\'identifiant de l\'enregistrement du choix pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_other:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_other:response'] = 'La réponse de texte spécifique.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_other:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response:pimenkoquestionnaireid'] = 'L\'identifiant de l\'enregistrement du questionnaire pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_rank'] = 'Une réponse à une question de rang.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_rank:choice_id'] = 'L\'identifiant de l\'enregistrement du choix pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_rank:question_id'] = 'L\'idnetifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_rank:rankvalue'] = 'La réponse de rang spécifique.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_rank:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response:submitted'] = 'Horodatage de la dernière sauvegarde pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_text'] = 'Une réponse à une question texte.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_text:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_text:response'] = 'La réponse de texte spécifique.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response_text:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_response:userid'] = 'L\'identifiant de l\'utilisateur pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_resp_single'] = 'Réponse à une question à choix unique.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_resp_single:choice_id'] = 'L\'identifiant de l\'enregistrement du choix pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_resp_single:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:pimenko_resp_single:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
...
$string['pimenkoquestionnaire:addinstance'] = 'Ajouter un questionnaire';
$string['pimenkoquestionnaire:administration'] = 'Administration du questionnaire';
$string['pimenkoquestionnaire:closes'] = 'Fermeture du questionnaire';
$string['pimenkoquestionnaire:copysurveys'] = 'Copier des questionnaires Modèles et Privés';
$string['pimenkoquestionnaire:createpublic'] = 'Créer des questionnaires Public';
$string['pimenkoquestionnaire:createtemplates'] = 'Créer des questionnaires Modèle';
$string['pimenkoquestionnaire:deleteresponses'] = 'Supprimer toutes les réponses';
$string['pimenkoquestionnaire:downloadresponses'] = 'Exporter les réponses au format texte/CSV';
$string['pimenkoquestionnaire:editquestions'] = 'Créer et modifier des questions de questionnaire';
$string['pimenkoquestionnaire:manage'] = 'Créer et modifier des questionnaires';
$string['pimenkoquestionnaire:message'] = 'Envoyer un message à ceux qui n\'ont pas encore répondu.';
$string['pimenkoquestionnaire:opens'] = 'Ouverture du questionnaire';
$string['pimenkoquestionnaire:preview'] = 'Prévisualiser les questionnaires';
$string['pimenkoquestionnaire:printblank'] = 'Imprimer un questionnaire vierge';
$string['pimenkoquestionnaire:readallresponseanytime'] = 'Voir toutes les réponses tout le temps';
$string['pimenkoquestionnaire:readallresponses'] = 'Voir les Résumés de réponses en fonction des dates d\'ouverture du questionnaire';
$string['pimenkoquestionnaire:readownresponses'] = 'Voir ses propres réponses';
$string['pimenkoquestionnaire:report'] = 'Rapport de questionnaire';
$string['pimenkoquestionnaire:submissionnotification'] = 'Recevoir une notification pour chaque envoi';
$string['pimenkoquestionnaire:submit'] = 'Répondre à un questionnaire et l\'envoyer';
$string['pimenkoquestionnaire:view'] = 'Voir un questionnaire';
$string['pimenkoquestionnaire:viewsingleresponse'] = 'Voir les réponses individuelles';
...
$string['questiontypes_link'] = 'mod/pimenkoquestionnaire/questions#Question_Types';
$string['radiobuttons'] = 'Boutons radio';
$string['radiobuttons_help'] = 'Type de question à choix multiple et à réponse unique.';
$string['radiobuttons_link'] = 'mod/pimenkoquestionnaire/questions#Radio_Buttons';
$string['rank'] = 'Rang';
$string['ratescale'] = 'Échelle de Likert';
$string['ratescale_help'] = 'Voir la documentation ci-dessous.';
$string['ratescale_link'] = 'mod/pimenkoquestionnaire/questions#Rate_.28scale_1..5.29';
...
$string['realm_link'] = 'mod/pimenkoquestionnaire/qsettings#Questionnaire_Type';
...
$string['required_link'] = 'mod/pimenkoquestionnaire/questions#Response_Required';
...
$string['respondenttype_link'] = 'mod/pimenkoquestionnaire/mod#Respondent_Type';
...
$string['responseview_link'] = 'mod/pimenkoquestionnaire/mod#Response_viewing';
...
$string['resume_link'] = 'mod/pimenkoquestionnaire/mod#Save.2FResume_answers';
...
$string['strictdateformatting'] = 'Utiliser le format jours/mois/année, par exemple pour le 4 mars 1945 : <strong>04/03/1945</ strong>';
