...
$string['privacy:metadata:pimenkoquestionnaire:_resp_multiple'] = 'Une réponse à une question à choix multiples.';
$string['privacy:metadata:pimenkoquestionnaire:_resp_multiple:choice_id'] = 'L\'identifiant d\'un enregistrement du choix pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_resp_multiple:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_resp_multiple:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response'] = 'Une réponse en cours ou envoyée';
$string['privacy:metadata:pimenkoquestionnaire:_response_bool'] = 'Une réponse à la question booléenne (oui/non).';
$string['privacy:metadata:pimenkoquestionnaire:_response_bool:choice_id'] = 'La réponse booléenne spécifique.';
$string['privacy:metadata:pimenkoquestionnaire:_response_bool:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_bool:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response:complete'] = 'Le statut d\'achèvement de la réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_date'] = 'Une réponse à une question de date.';
$string['privacy:metadata:pimenkoquestionnaire:_response_date:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_date:response'] = 'La date spécifique de réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_date:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response:grade'] = 'La note pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_other'] = 'Une réponse de type « autre » choix.';
$string['privacy:metadata:pimenkoquestionnaire:_response_other:choice_id'] = 'L\'identifiant de l\'enregistrement du choix pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_other:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_other:response'] = 'La réponse de texte spécifique.';
$string['privacy:metadata:pimenkoquestionnaire:_response_other:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response:pimenkoquestionnaire:id'] = 'L\'identifiant de l\'enregistrement du questionnaire pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_rank'] = 'Une réponse à une question de rang.';
$string['privacy:metadata:pimenkoquestionnaire:_response_rank:choice_id'] = 'L\'identifiant de l\'enregistrement du choix pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_rank:question_id'] = 'L\'idnetifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_rank:rankvalue'] = 'La réponse de rang spécifique.';
$string['privacy:metadata:pimenkoquestionnaire:_response_rank:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response:submitted'] = 'Horodatage de la dernière sauvegarde pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_text'] = 'Une réponse à une question texte.';
$string['privacy:metadata:pimenkoquestionnaire:_response_text:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response_text:response'] = 'La réponse de texte spécifique.';
$string['privacy:metadata:pimenkoquestionnaire:_response_text:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_response:userid'] = 'L\'identifiant de l\'utilisateur pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_resp_single'] = 'Réponse à une question à choix unique.';
$string['privacy:metadata:pimenkoquestionnaire:_resp_single:choice_id'] = 'L\'identifiant de l\'enregistrement du choix pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_resp_single:question_id'] = 'L\'identifiant de l\'enregistrement de la question pour cette réponse.';
$string['privacy:metadata:pimenkoquestionnaire:_resp_single:response_id'] = 'L\'identifiant de l\'enregistrement de la réponse pour cette réponse.';
