 ...
 * pimenkoquestionnaire with conditional branching.
 */
...
M.mod_pimenkoquestionnaire = M.mod_pimenkoquestionnaire || {};

/* exported Y */
/* exported e */
M.mod_pimenkoquestionnaire.init_attempt_form = function(Y) {
    M.core_formchangechecker.init({formid: 'phpesp_response'});
};

M.mod_pimenkoquestionnaire.init_sendmessage = function(Y) {
