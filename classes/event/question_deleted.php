...
/**
 * The mod_pimenkoquestionnaire question_deleted event.
 *
...
/**
 * The mod_pimenkoquestionnaire question_deleted event class.
 *
 * @package    mod_pimenkoquestionnaire
 * @since      Moodle 2.7
 * @copyright  2014 Joseph Rézeau <moodle@rezeau.org>
...
class question_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_question_deleted', 'mod_pimenkoquestionnaire');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has deleted a question of type '$questiontype' for
            the pimenkoquestionnaire with course module id '$this->contextinstanceid'.";
    }
}