...
/**
 * The mod_pimenkoquestionnaire question_created event.
 *
...
/**
 * The mod_pimenkoquestionnaire question_created event class.
 *
 * @package    mod_pimenkoquestionnaire
 * @since      Moodle 2.7
 * @copyright  2014 Joseph Rézeau <moodle@rezeau.org>
...
class question_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_question_created', 'mod_pimenkoquestionnaire');
    }
