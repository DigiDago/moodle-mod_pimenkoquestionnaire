...
/**
 * The mod_pimenkoquestionnaire attempt_resumed event.
 *
...
class attempt_resumed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_resumed', 'mod_pimenkoquestionnaire');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' resumed an attempt for the pimenkoquestionnaire
