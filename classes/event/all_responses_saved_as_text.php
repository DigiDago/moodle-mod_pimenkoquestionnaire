...
/**
 * The mod_pimenkoquestionnaire all_responses_saved_as_text event.
 *
...
/**
 * The mod_pimenkoquestionnaire all_responses_saved_as_text event class.
 *
 * @package    mod_pimenkoquestionnaire
 * @since      Moodle 2.7
 * @copyright  2014 Joseph Rézeau <moodle@rezeau.org>
...
class all_responses_saved_as_text extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_all_responses_saved_as_text', 'mod_pimenkoquestionnaire');
    }
