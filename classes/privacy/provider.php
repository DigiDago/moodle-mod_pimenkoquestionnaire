...
/**
 * Contains class mod_pimenkoquestionnaire\privacy\provider
 *
...
namespace mod_pimenkoquestionnaire\privacy;
...
class provider implements
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
       ...
       INNER JOIN {pimenkoquestionnaire} q ON q.id = cm.instance
       INNER JOIN {pimenko_response} qr ON qr.pimenkoquestionnaireid = q.id
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        $params = ['modname' => 'pimenkoquestionnaire', 'contextlevel' => CONTEXT_MODULE, 'userid' => $user->id] + $contextparams;
        ...
        foreach ($responses as $response) {
            ...
            if ($lastcmid != $response->cmid) {
                ...
                $cm = get_coursemodule_from_instance("pimenkoquestionnaire", $response->qid, $course->id);
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        if (!$cm = get_coursemodule_from_id('pimenkoquestionnaire', $context->instanceid)) {
            return;
        }
        ...
        if ($responses = $DB->get_recordset('pimenko_response', ['pimenkoquestionnaireid' => $pimenkoquestionnaire->id])) {
            self::delete_responses($responses);
        }
        $responses->close();
        $DB->delete_records('pimenko_response', ['pimenkoquestionnaireid' => $pimenkoquestionnaire->id]);
    }
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist) {
        ...
        foreach ($contextlist->get_contexts() as $context) {
            ...
            $responses->close();
            $DB->delete_records('pimenko_response', ['pimenkoquestionnaireid' => $pimenkoquestionnaire->id, 'userid' => $userid]);
        }
    }
    ...
    public static function delete_data_for_users(approved_userlist $userlist) {
        ...
        $params = array_merge(['pimenkoquestionnaireid' => $pimenkoquestionnaire->id], $userinparams);
        $select = 'pimenkoquestionnaireid = :pimenkoquestionnaireid AND userid ' . $userinsql;
        if ($responses = $DB->get_recordset_select('pimenko_response', $select, $params)) {
            self::delete_responses($responses);
        }
        $responses->close();
