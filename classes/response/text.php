...
class text extends base {
    ...
    public function results_template() {
        return 'mod_pimenkoquestionnaire/results_text';
    }
    ...
    public function get_results_tags( $weights, $participants, $respondents, $showtotals = 1, $sort = '' ) {
        ...
        if (is_object(reset($weights))) {
            global $CFG, $SESSION, $pimenkoquestionnaire, $DB;
            $viewsingleresponse = $pimenkoquestionnaire->capabilities->viewsingleresponse;
            $nonanonymous = $pimenkoquestionnaire->respondenttype != 'anonymous';
            ...
            $nbresponses = 0;
            $sum = 0;
            $strtotal = get_string('totalofnumbers', 'pimenkoquestionnaire');
            $straverage = get_string('average', 'pimenkoquestionnaire');
