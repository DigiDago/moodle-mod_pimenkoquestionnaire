...
class settings_form extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'title', get_string('title', 'pimenkoquestionnaire'), ['size' => '60']);
        ...
        $mform->addElement('text', 'subtitle', get_string('subtitle', 'pimenkoquestionnaire'), ['size' => '60']);
        ...
        $mform->addElement('text', 'thanks_page', get_string('url', 'pimenkoquestionnaire'), ['size' => '60']);
        ...
        $mform->addElement('text', 'thank_head', get_string('headingtext', 'pimenkoquestionnaire'), ['size' => '30']);
        ...
        $mform->addElement('text', 'email', get_string('email', 'pimenkoquestionnaire'), ['size' => '75']);
