...
/**
 * Contains class mod_pimenkoquestionnaire\search\question
 *
...
class question extends \core_search\base_mod {
    ...
    public function get_document($record, $options = []) {
        ...
        try {
            $cm = $this->get_cm('pimenkoquestionnaire', $record->id, $record->course);
    ...
    public function check_access($id) {
        ...
        try {
            ...
            $cminfo = $this->get_cm('pimenkoquestionnaire', $activity->id, $activity->course);
