...
Feature: In pimenkoquestionnaire, personality tests can be constructed using feedback on specific question responses and questions can be
  ...
  @javascript
  Scenario: Create a pimenkoquestionnaire with a with feeback question types and add more than one feedback section.
