...
Feature: In pimenkoquestionnaire, yes/no questions can be defined with scores attributed to specific answers, in order
  ...
  @javascript
  Scenario: Create a pimenkoquestionnaire with a yes/no question type and verify that feedback options exist.
