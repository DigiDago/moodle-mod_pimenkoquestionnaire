...
Feature: Add questions to a pimenkoquestionnaire activity
  In order to conduct surveys of the users in a course
  As a teacher
  I need to add a pimenkoquestionnaire activity with questions to a moodle course

@javascript
  Scenario: Add a pimenkoquestionnaire to a course with one of each question type
