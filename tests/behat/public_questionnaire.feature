...
Feature: Questionnaires can use an existing public survey to gather responses in one place.
  ...
  Background: Add a public pimenkoquestionnaire and use it in two different course.
    ...
    And I follow "Public pimenkoquestionnaire"
    ...
    And I click on "Public pimenkoquestionnaire [Course 1]" "radio"
    And I press "Save and display"
  ...
  @javascript
  Scenario: Student completes public pimenkoquestionnaire instances in two different courses and sees each response in the proper course
    ...
    And I press "Submit pimenkoquestionnaire"
    Then I should see "Thank you for completing this Questionnaire."
    And I follow "Continue"
    Then I should see "Your response"
    And I should see "Enter a number"
    And "//div[contains(@class,'pimenkoquestionnaire_numeric') and contains(@class,'pimenkoquestionnaire_response')]//span[@class='selected' and text()='1']" "xpath_element" should exist
    ...
    Then I should see "Your response"
    And I should see "Enter a number"
    And "//div[contains(@class,'pimenkoquestionnaire_numeric') and contains(@class,'pimenkoquestionnaire_response')]//span[@class='selected' and text()='2']" "xpath_element" should exist
