...
Feature: Questionnaires can be public, private or template
  In order to view a pimenkoquestionnaire
  As a user
  The type of the pimenkoquestionnaire affects how it is displayed.

@javascript
  Scenario: Add a template pimenkoquestionnaire
...
@javascript
  Scenario: Add a pimenkoquestionnaire from a public pimenkoquestionnaire
    Given the following "users" exist:
      | username | firstname | lastname | email |
      | manager1 | Manager | 1 | manager1@example.com |
      | teacher1 | Teacher | 1 | teacher1@example.com |
...
# Verify that a public pimenkoquestionnaire cannot be used in the same course.
    And I turn editing mode on
    And I add a "Questionnaire" to section "1"
    And I expand all fieldsets
    Then I should see "(No public questionnaires.)"
    And I press "Cancel"
# Verify that a public pimenkoquestionnaire can be used in a different course.
    And I am on site homepage
    And I am on "Course 2" course homepage
    And I add a "Questionnaire" to section "1"
    And I expand all fieldsets
    And I set the field "name" to "Questionnaire from public"
    And I click on "Test pimenkoquestionnaire [Course 1]" "radio"
    And I press "Save and return to course"
    And I log out
...
# Verify message for public pimenkoquestionnaire that has been deleted.
    And I log out
    And I log in as "manager1"
    And I am on site homepage
    And I am on "Course 1" course homepage
    And I turn editing mode on
    And I delete "Test pimenkoquestionnaire" activity
    And I am on site homepage
    And I am on "Course 2" course homepage
    And I follow "Questionnaire from public"
    Then I should see "This pimenkoquestionnaire used to depend on a Public pimenkoquestionnaire which has been deleted."
    And I should see "It can no longer be used and should be deleted."
    And I log out
    And I log in as "student1"
    And I am on "Course 2" course homepage
    And I follow "Questionnaire from public"
    Then I should see "This pimenkoquestionnaire is no longer available. Ask your teacher to delete it."