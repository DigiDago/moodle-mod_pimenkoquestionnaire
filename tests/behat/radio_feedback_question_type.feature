...
Feature: In pimenkoquestionnaire, radio questions can be defined with scores attributed to specific answers, in order
  ...
  @javascript
  Scenario: Create a pimenkoquestionnaire with a radio question type and verify that feedback options exist.
