...
Feature: Public questionnaires gather all instance responses in one master course, but not in the instance courses.
  ...
  When teachers view the main public course pimenkoquestionnaire, they will see all instances' responses.
  ...
  @javascript
  Scenario: Teacher should not see responses for a pimenkoquestionnaire using a public instance
    And I log in as "teacher2"
    And I am on "Course 2" course homepage with editing mode on
    And I follow "Questionnaire instance 1"
  ...
  # Scenario: Teacher in course with main public pimenkoquestionnaire should see all responses
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Public pimenkoquestionnaire"
