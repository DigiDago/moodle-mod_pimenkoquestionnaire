...
#    And I should see "Thursday, 14 January 2016, 9:22 pm"
    And I should see "Test pimenkoquestionnaire"
    And I follow "Next"
...
#    And I should see "Friday, 19 December 2014, 5:58 pm"
    ...
    Then I should see "Are you sure you want to delete ALL the responses in this pimenkoquestionnaire?"
    And I press "Delete"
    Then I should see "You are not eligible to take this pimenkoquestionnaire."
