...
class restore_pimenkoquestionnaire_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_pimenkoquestionnaire_activity_structure_step('pimenkoquestionnaire_structure',
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('pimenkoquestionnaire', ['intro'], 'pimenkoquestionnaire');
        $contents[] = new restore_decode_content('pimenkoquestionnaire_survey',
                ['info', 'thank_head', 'thank_body', 'thanks_page'], 'pimenkoquestionnaire_survey');
        $contents[] = new restore_decode_content('pimenko_question', ['content'], 'pimenko_question');
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('pimenkoquestionnaire', 'choose again', 'view.php?id={course_module}',
                '{pimenkoquestionnaire}');
        $rules[] =
                new restore_log_rule('pimenkoquestionnaire', 'report', 'report.php?id={course_module}', '{pimenkoquestionnaire}');
