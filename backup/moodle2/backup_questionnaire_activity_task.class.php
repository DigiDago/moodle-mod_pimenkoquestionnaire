...
require_once($CFG->dirroot . '/mod/pimenkoquestionnaire/backup/moodle2/backup_pimenkoquestionnaire_stepslib.php');
// Because it exists (optional).
require_once($CFG->dirroot . '/mod/pimenkoquestionnaire/backup/moodle2/backup_pimenkoquestionnaire_settingslib.php');

/**
 * pimenkoquestionnaire backup task that provides all the settings and steps to perform one
 * complete backup of the activity
 */
class backup_pimenkoquestionnaire_activity_task extends backup_activity_task {
